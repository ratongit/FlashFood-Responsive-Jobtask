...
const HowItWork = () => {
  ...
  <img className="max-w-sm  z-50 lg:hidden" src="https://assets-global.website-files.com/5e4482baa13a1926b23e2187/61fb155d422b521236149f54_Hero%20img-p-1600.png"></img>
    ...
    <div>
      <h1 className="lg:text-4xl xl:w-9/12 p-5 rounded-2xl lg:w-10/12 text-3xl font-bold">First, use the free app to quickly and easily find discounted food from wherever you are.</h1>
     
     <nav>
     <ul style={{ listStyleType: 'circle' }} className="list-disc ms-8 lg:my-10 my-5 flex flex-col gap-5 text-lg font-serif text-gray-600">
  <li>Browse deals of up to 50% off at a grocery store location near you. <Link className="text-blue-500 font-semibold">See Locations > </Link></li>
